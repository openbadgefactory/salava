    ...
    [:div {:id "page-view"}
     ...
     (if (:owner? page)
       [:div {:id "page-buttons-share"}
        ...
        [:div {:class (str "share-wrapper " @visibility-atom " forced-ltr") } [s/share-buttons (str (session/get :site-url) (path-for "/page/view/") (:id page)) (:name page) (= "public" (:visibility page)) false show-link-or-embed-atom]]]
