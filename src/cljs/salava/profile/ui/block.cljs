  ...
  (fn []
   (let [{:keys [tips completion_percentage]} @state]
    [:div#profiletips
     ...
     (when (some #(true? %) (vals (dissoc tips :tabs-tip :showcase-tip))) [:div.col-xs-12 {:style {:margin "5px 2px" :font-size "14px" :font-weight "bold"}} (t :profile/Tipstoimproveprofile)])
