...
(defn send-activation-message [site-url activation-link login-link fullname email-address]
...
(defn send-password-reset-message [site-url activation-link fullname email-address]
