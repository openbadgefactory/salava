...
(s/defschema alignment-m {:name s/Str
                          :description (s/maybe s/Str)
                          :url (s/maybe s/Str)})
...
(s/defschema user-badge-content-m (-> user-badge-m
                                      (assoc :content              [badge-content-m]
                                             ...
                                             :owner_id             (describe s/Int "internal id of badge owner")
                                             ...
                                             :gallery_id             (describe s/Int "internal gallery badge id")
...
(s/defschema gallery-badge-m {:id           (describe s/Int "internal gallery id")
                              :badge_id     (describe s/Str "internal badge content id")
                              :name         (s/maybe s/Str)
                              :description  (s/maybe s/Str)
                              :image_file   (s/maybe s/Str)
